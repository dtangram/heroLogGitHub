...
const emailPasswordResetCtrl = require('../controllers/emailpasswordreset');
...
router.get('/emailpasswordreset', emailPasswordResetCtrl.emailpasswordreset);

router.post('/emailpasswordreset', [
